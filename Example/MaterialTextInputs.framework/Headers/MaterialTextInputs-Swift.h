...
SWIFT_MODULE_NAMESPACE_PUSH("MaterialTextInputs")
@class NSCoder;
@class UIFont;
@class UIColor;

SWIFT_CLASS("_TtC18MaterialTextInputs17MaterialTextField")
...
@property (nonatomic) BOOL reservePlaceForTitle;
@property (nonatomic, copy) NSString * _Nullable placeholder;
@property (nonatomic) CGFloat titleBottomInset;
...
SWIFT_CLASS("_TtC18MaterialTextInputs16MaterialTextView")
@interface MaterialTextView : UITextView
